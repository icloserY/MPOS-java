...
<div class="col-lg-6">
	<div class="panel panel-info">
					...
					<c:forEach var="shares" items="${CONTRIBSHARES }">
						...
						<tr class="${classVar }">
							...
							<td><c:choose>
									...
									<c:when
										test="${shares.donate_percent < 2 and shares.donate_percent > 0 }">
							...
							<c:if
								test="${shares.is_anonymous == 1 and USERDATA.is_admin == 0 }">
								<c:set var="tdAccount" value="anonymous" />
							</c:if>
							<td>${tdAccount }</td>
							<fmt:parseNumber var="shares" integerOnly="true"
								value="${shares.shares}" />
		...
		<div class="panel-footer">
			<h6>
				<i class="fa fa-ban fa-fw"></i>no Donation <i
					class="fa fa-star-o fa-fw"></i> 0&#37;&#45;2&#37; Donation <i
					class="fa fa-trophy fa-fw"></i> 2&#37; or more Donation
			</h6>
		</div>
	</div>
</div>
