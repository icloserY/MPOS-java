	...
	<div class="row">
		...
		<div class="col-lg-2 col-sm-6">
			<div class="circle-tile fade">
				...
				<div class="circle-tile-content lightblue">
					<div class="circle-tile-description text-faded">
						<p class="h5" id="b-roundprogress">${ESTIMATES.percent}%</p>
					</div>
					<div class="circle-tile-number text-faded">
		...
		<div class="col-lg-2 col-sm-6">
			<div class="circle-tile fade">
				...
				<div class="circle-tile-content lightblue">
					<div class="circle-tile-description text-faded">
						<p class="h5" id="b-payout">50.000000000000</p>
					</div>
					<div class="circle-tile-number text-faded">
						<p class="h6">LTC Est. Earnings</p>
					</div>
				</div>
			</div>
		</div>
		<div class="col-lg-2 col-sm-6">
			<div class="circle-tile fade">
				...
				<div class="circle-tile-content lightblue">
					<div class="circle-tile-description text-faded">
						<p class="h5" id="b-diff">${NETWORK.difficulty}</p>
					</div>
					<div class="circle-tile-number text-faded">
		...
		<div class="col-lg-2 col-sm-6">
			<div class="circle-tile fade">
				...
				<div class="circle-tile-content lightblue">
					<div class="circle-tile-description text-faded">
						<p class="h5" id="b-nextdiff">
						<c:if test="${nethashrate > 0 }">
						${NETWORK.EstNextDifficulty}
						</c:if>
						<c:if test="${nethashrate <= 0 }">
						n/a
						</c:if>
					...
					<div class="circle-tile-number text-faded">
						<p class="h6">
							Est. Next Difficulty
							<c:if test="${nethashrate > 0 }">
								<br />Change in ${NETWORK.BlocksUntilDiffChange} Blocks
						</c:if>
						</p>
					</div>
				</div>
		...
		<div class="col-lg-2 col-sm-6">
			<div class="circle-tile fade">
				...
				<div class="circle-tile-content lightblue">
					<div class="circle-tile-description text-faded">
						<p class="h5" id="b-esttimeperblock">${NETWORK.EstTimePerBlock}</p>
					</div>
					<div class="circle-tile-number text-faded">
