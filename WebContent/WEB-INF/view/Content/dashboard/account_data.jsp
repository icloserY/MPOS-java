  ...
  <div class="col-lg-4">
    ...
    {else}
        ...
        <table class="table table-bordered table-hover table-striped">
          <thead>
            <tr><th colspan="2"><!-- {$GLOBAL.config.currency}-->LTC Account Balance</th></tr>
          </thead>
          <tbody>
            <tr>
              <th>Confirmed</th>
              <th>
                <span class="label label-success pull-right bigfont" id="b-confirmed"><!-- {$GLOBAL.userdata.balance.confirmed|number_format:"6"} -->0.00</span>
              </th>
            </tr>
            <tr>
              <th>Unconfirmed</th>
              <th>
                <span class="label label-warning pull-right bigfont" id="b-unconfirmed"><!-- {$GLOBAL.userdata.balance.unconfirmed|number_format:"6"}-->0.00</span>
              </th>
            </tr>
          </tbody>
        </table>
